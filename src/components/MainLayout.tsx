...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-[#000000] text-white overflow-hidden">
      <main className={`flex-1 min-h-0 ${activeTab === 'coach' ? 'overflow-hidden flex flex-col pb-[calc(5.2rem+env(safe-area-inset-bottom))]' : 'overflow-y-auto pb-[calc(6.5rem+env(safe-area-inset-bottom))]'} scrollbar-hide`}>
        {children}
      </main>
