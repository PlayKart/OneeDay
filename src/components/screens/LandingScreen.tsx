      ...
      {view === "privacy" ? (
        ...
        >
          ...
          <main className="relative z-10 space-y-20 md:space-y-36 pt-4">
            {/* HERO SECTION */}
            <section className="relative pt-12 md:pt-20 pb-12 px-5 max-w-5xl mx-auto flex flex-col justify-center text-center">
              <div className="space-y-6 md:space-y-8">
                {/* Eyebrow badge */}
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-violet-500/10 via-purple-500/10 to-indigo-500/10 border border-violet-500/20 px-4 py-1.5 rounded-full text-[11px] md:text-xs font-medium tracking-wide text-violet-300 mx-auto select-none shadow-[0_2px_10px_rgba(139,92,246,0.1)]">
                ...
                {/* Hero Headline */}
                <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.08] text-white">
                ...
                {/* Subtitle */}
                <p className="text-sm md:text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed font-normal">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4 max-w-xs sm:max-w-md mx-auto">
                  <button 
                    onClick={openAuthModal}
                    className="w-full sm:w-auto bg-white text-black px-8 py-3.5 rounded-full text-sm font-semibold tracking-tight hover:bg-zinc-100 active:scale-95 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] cursor-pointer flex items-center justify-center gap-2 group"
                  >
                  ...
                  <button 
                    ...
                    className="w-full sm:w-auto bg-white/[0.04] hover:bg-white/[0.08] text-zinc-300 hover:text-white border border-white/10 px-8 py-3.5 rounded-full text-sm font-semibold tracking-tight transition-all active:scale-95 cursor-pointer backdrop-blur-md"
                  >
                    Explore Features
                  </button>
                </div>
            ...
            <section id="about" className="px-5 max-w-5xl mx-auto space-y-12 scroll-mt-28">
              <div className="text-center space-y-4 max-w-2xl mx-auto">
                <div className="inline-flex items-center gap-2 text-violet-400 text-xs font-mono font-semibold tracking-widest uppercase">
                  <GraduationCap size={15} />
                  <span>STUDENT CREATORS</span>
                </div>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold tracking-tight text-white">Built with care.</h2>
                <p className="text-xs md:text-sm text-zinc-400 leading-relaxed">
                  OneDay is built by students who wanted a cleaner, more focused way to build discipline, consistency and better habits.
                </p>
                <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/20 rounded-full px-4 py-1.5 text-[11px] md:text-xs text-violet-200 font-medium">
                  <span>We are students of:</span>
                  <strong className="text-white">Kendriya Vidyalaya Gachibowli (KVGB)</strong>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Team Member 1 */}
                <div className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-6 md:p-8 flex flex-col items-center text-center space-y-4 hover:border-violet-500/40 hover:bg-white/[0.04] transition-all duration-300 shadow-xl group">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-b from-zinc-800 to-zinc-900 border border-white/15 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] flex items-center justify-center font-bold text-white text-xl select-none group-hover:border-violet-400 transition-colors">
                    K
                  </div>
                  <div className="space-y-1">
                    <h3 className="font-bold text-sm md:text-base text-white tracking-tight">Kante Harsha Vardhan</h3>
                    <p className="text-[10px] font-mono uppercase tracking-wider text-violet-400 font-semibold">Founder — Core Idea & Product Vision</p>
                  </div>
                ...
                <div className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-6 md:p-8 flex flex-col items-center text-center space-y-4 hover:border-violet-500/40 hover:bg-white/[0.04] transition-all duration-300 shadow-xl group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-mono uppercase tracking-wider text-violet-400 font-semibold">Feature Strategy & Systems Planning</p>
                  </div>
                  <p className="text-xs text-zinc-400 leading-relaxed max-w-[260px]">
                ...
                <div className="bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-6 md:p-8 flex flex-col items-center text-center space-y-4 hover:border-violet-500/40 hover:bg-white/[0.04] transition-all duration-300 shadow-xl group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-mono uppercase tracking-wider text-violet-400 font-semibold">Design & User Experience</p>
                  </div>
                  <p className="text-xs text-zinc-400 leading-relaxed max-w-[260px]">
              ...
              <div className="pt-6 border-t border-white/10 max-w-md mx-auto text-center space-y-2">
                <span className="text-[10px] font-mono tracking-widest text-violet-400 font-bold uppercase block">BUILT BY STUDENTS</span>
                <p className="text-xs font-bold text-zinc-200">Kendriya Vidyalaya Gachibowli (KVGB)</p>
            ...
            <section className="px-5 max-w-4xl mx-auto py-8">
              <div className="relative overflow-hidden bg-gradient-to-b from-violet-950/20 via-zinc-950 to-black border border-violet-500/20 rounded-3xl md:rounded-[2.5rem] p-8 md:p-16 text-center space-y-6 shadow-[0_0_50px_rgba(139,92,246,0.1)]">
                <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-96 h-48 bg-violet-600/20 rounded-full blur-3xl pointer-events-none" />
                
                <div className="space-y-3 relative z-10">
                  <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight text-white">Start with one day.</h2>
                ...
                <div className="relative z-10">
                  <button 
                    onClick={openAuthModal}
                    className="bg-white text-black px-10 py-4 rounded-full text-sm font-semibold tracking-tight hover:bg-zinc-100 active:scale-95 transition-all shadow-[0_0_30px_rgba(255,255,255,0.25)] cursor-pointer inline-flex items-center gap-2 group"
                  >
                    <span>Start Your Journey</span>
