...
export function LandingScreen({ onLoginSuccess }: LandingScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white selection:bg-white/30 font-sans w-full overflow-x-hidden">
      {/* NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#000000]/80 backdrop-blur-xl border-b border-white/5 h-20 flex items-center px-6 md:px-12">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          ...
          <button 
            ...
            className="bg-white text-black px-6 py-2.5 rounded-full text-sm font-bold tracking-tight hover:bg-slate-200 transition-all transform hover:scale-105"
          >
            Start Now
          </button>
        </div>
      ...
      <section className="pt-48 pb-32 px-6 bg-gradient-to-b from-[#0a0a0a] to-black min-h-[90vh] flex flex-col justify-center">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-black tracking-tighter leading-[1.1] bg-clip-text text-transparent bg-gradient-to-br from-white via-white to-white/50"
          >
          ...
          >
            <button 
              onClick={() => setShowAuthModal(true)}
              className="bg-white text-black px-12 py-5 rounded-full text-lg font-bold tracking-tight hover:bg-slate-200 transition-all transform hover:scale-105 shadow-[0_0_40px_rgba(255,255,255,0.15)]"
            >
              Start Your Journey
            </button>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#0a0a0a] border border-white/5 rounded-[2.5rem] p-12 hover:border-white/20 transition-colors group">
              ...
              <div className="space-y-6">
                <div className="text-2xl font-bold tracking-tight">Systematic Progress</div>
            ...
            <div className="bg-[#0a0a0a] border border-white/5 rounded-[2.5rem] p-12 hover:border-white/20 transition-colors group">
              ...
              <div className="space-y-6">
                <div className="text-2xl font-bold tracking-tight">Intelligence & Focus</div>
                <ul className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <button 
              ...
              className="mt-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white px-8 py-3 rounded-full text-sm font-bold tracking-tight transition-all"
            >
              Explore Features
            </button>
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                <button 
                  ...
                  className="w-full bg-white text-black font-bold py-4 rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-200 transition-all text-sm tracking-tight"
                >
                ...
                <button 
                  ...
                  className="w-full bg-white/5 border border-white/10 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all text-sm tracking-tight"
                >
                  <User size={20} />
                  Continue as Guest
                </button>
